...
{
    // // Logic 1 this will check the prompt from chatgpt if the user wants to create an image
    let isArt;
    try {
    ...
    // // Logic 2: sometimes chatgpt does not understand the art messages, but that's fine, you can use this approach :)
